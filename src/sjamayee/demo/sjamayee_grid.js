/*                                            SjamayeeForm !!!
SjamayeeForm.NAME = "SJAMAYEEFORM";
SjamayeeForm.MODE_DISPLAY = "DISPLAY";
SjamayeeForm.MODE_EDIT = "EDIT";
SjamayeeForm.MODE_INSERT = "INSERT";
SjamayeeForm.NAVIGATION_CONTROL_ID = "navigationControl";
SjamayeeForm.IMAGE_SMALL = "small";
SjamayeeForm.IMAGE_MEDIUM = "medium";
SjamayeeForm.IMAGE_LARGE = "large";
SjamayeeForm.HEADER_PANE_ID = "headerPane";
SjamayeeForm.LIST_SPLITTER_ID = "listSplitter";
SjamayeeForm.LIST_PANE_BORDER_ID = "listPaneBorder";
SjamayeeForm.LIST_PANE_LEFT_ID = "listPaneLeft";
SjamayeeForm.LIST_PANE_RIGHT_ID = "listPaneRight";
//Detail DIV's in correct order.
SjamayeeForm.DETAIL_SPLITTER_ID = "detailSplitter";
SjamayeeForm.TOOLBAR_PANE_ID = "toolBar";
SjamayeeForm.DETAIL_PANE_ID = "detailPane";
SjamayeeForm.DETAIL_PANE_LEFT_ID = "detailPaneLeft";
SjamayeeForm.DETAIL_PANE_RIGHT_ID = "detailPaneRight";
SjamayeeForm.SFDC_EDIT_PARENT = "EDIT_PARENT";
SjamayeeForm.SFDC_SHOW_PARENT = "SHOW_PARENT";
SjamayeeForm.SFDC_EDIT_CHILD = "EDIT_CHILD";
SjamayeeForm.SFDC_SHOW_CHILD = "SHOW_CHILD";
SjamayeeForm.SFDC_EDIT_OBJECT = "EDIT_OBJECT";
SjamayeeForm.SFDC_SHOW_OBJECT = "SHOW_OBJECT";
SjamayeeForm.CURSOR_AUTO = "auto";
SjamayeeForm.CURSOR_ALL_SCROLL = "all-scroll";
SjamayeeForm.CURSOR_DEFAULT = "default";
SjamayeeForm.CURSOR_HAND = "hand";
SjamayeeForm.CURSOR_POINTER = "pointer";
SjamayeeForm.CURSOR_MOVE = "move";
SjamayeeForm.CURSOR_NOT_ALLOWED = "not-allowed";
SjamayeeForm.CURSOR_WAIT = "wait";
SjamayeeForm.PREVIOUS_NIVO_ID = "page:sja_form:previousNivo";
SjamayeeForm.CURRENT_NIVO_ID = "page:sja_form:currentNivo";
SjamayeeForm.NIVOS_ID = "page:sja_form:nivos";
SjamayeeForm.LEFT = "LEFT";
//SjamayeeForm.ROOT = "ROOT";
SjamayeeForm.RIGHT = "RIGHT";
SjamayeeForm.SELECTION_PANEL_ID = "selectionPanel";
SjamayeeForm.SELECTION_ENTITY_PANEL_ID = "selectionEntityPanel";
SjamayeeForm.SELECTION_TYPE_PANEL_ID = "selectionTypePanel";
SjamayeeForm.FILTER_BUTTON_ID = "filterButton";
SjamayeeForm.SETTINGS_PANEL_ID = "settingsPanel";
SjamayeeForm.SETTNGS_BUTTON_ID = "settingsButton";
SjamayeeForm.SCRAMBLE_BUTTON_ID = "scrambleButton";
SjamayeeForm.HELP_LINK_ID = "helpLink";
SjamayeeForm.STATUS_MESSAGE_DISPLAY_LBL = "Display...";
SjamayeeForm.STATUS_MESSAGE_EDIT_LBL = "Edit...";
SjamayeeForm.STATUS_MESSAGE_INSERT_LBL = "Insert...";
SjamayeeForm.STATUS_MESSAGE_DELETE_LBL = "Delete...";
SjamayeeForm.STATUS_MESSAGE_EXTRACT_LBL = "Extract...";
SjamayeeForm.STATUS_MESSAGE_COPY_LBL = "Copy...";
SjamayeeForm.STATUS_MESSAGE_PASTE_LBL = "Paste...";
SjamayeeForm.STATUS_MESSAGE_UNDO_LBL = "Undo...";
SjamayeeForm.STATUS_MESSAGE_REDO_LBL = "Redo...";
SjamayeeForm.STATUS_MESSAGE_CLEAR_BUFFER_LBL = "Clear buffer...";
SjamayeeForm.STATUS_MESSAGE_ESCAPE_LBL = " Press ESC-key to Cancel.";
SjamayeeForm.STATUS_MESSAGE_ID = "statusMessage";
SjamayeeForm.DETAIL_BUTTONS_ID = "detailButtons";
SjamayeeForm.CONTROL_BUTTONS_ID = "controlButtons";
SjamayeeForm.CONTROL_BUTTONS_LEFT_ID = "controlButtonsLeft";
SjamayeeForm.CONTROL_BUTTONS_CENTER_ID = "controlButtonsCenter";
SjamayeeForm.CONTROL_BUTTONS_RIGHT_ID = "controlButtonsRight";
SjamayeeForm.FORM_BUTTON_HOLDER_ID = "@@formButton@@";
SjamayeeForm.ENTITY_LIST_REFERENCE_SELECTION_HOLDER_ID = "@@entityList_ReferenceSelection@@";
SjamayeeForm.ROOT_BUTTONS_HOLDER_ID = "@@rootButtons@@";
SjamayeeForm.TYPE_SELECTION_LIST_HOLDER_ID = "@@typeSelectionList@@";
SjamayeeForm.CONTROL_BUTTONS_LEFT_HOLDER_ID = "@@controlButtonsLeft@@";
SjamayeeForm.CONTROL_BUTTONS_CENTER_HOLDER_ID = "@@controlButtonsCenter@@";
SjamayeeForm.CONTROL_BUTTONS_RIGHT_HOLDER_ID = "@@controlButtonsRight@@";
SjamayeeForm.DETAIL_PANE_LEFT_HOLDER_ID = "@@detailPaneLeft@@";
SjamayeeForm.DETAIL_PANE_RIGHT_HOLDER_ID = "@@detailPaneRight@@";
SjamayeeForm.LIST_PANE_CLASS_ID = "listPane";
SjamayeeForm.NORMAL_BORDER_CLASS_ID = "normalBorder";
SjamayeeForm.NONE_BORDER_CLASS_ID = "noneBorder";
SjamayeeForm.NONE_BORDER_LIST_CLASS_ID = "noneListBorder";
SjamayeeForm.FOCUSED_BORDER_CLASS_ID = "focusedBorder";
SjamayeeForm.FOCUSED_BORDER_LIST_CLASS_ID = "focusedListBorder";

SjamayeeForm.COLOR_DOT = function()              { return "red"; }
SjamayeeForm.COLOR_DOT_ROOT = function()         { return "white"; }
SjamayeeForm.COLOR_DOT_ROOT_FOCUSED = function() { return "black"; }
*/

//-----------------------------//
// Sjamayee Javascript Library //
//-----------------------------//
//CachedObjectVO
//  AttributeVO
//  EntityVO
...
//              - GridView
//              - Position
//              - ReferenceExpression                        //Temporary/Test
//							- SavedLocation
//              - SnapShot
//              - FontStyle
//							- Queue
...
//TOREMEMBER:
// 1. dd57751eb:~/Desktop/sjamayee/salesforce/static_resources creemej$ ../../jsl-0.3.0-mac/jsl -process sjamayee.js

//TODO: SjamayeeForm >>> Form >> ObjectsForm > RelationsForm :: Complete !!!!

//TODO:
// 1. set alert grid.switchEntity !!!!!!  (dubbel call)
//*2. GRID_TABLE_ID
//*3. GRID_PANEL_ID - obsolete !
// 4. SjamayeeForm ... ID'S !!! (get/set)
//*5. PARENT_PROPERTYTABLE_ID
//*6. CHILD_PROPERTYTABLE_ID
// 7. 6x Grid/refresh - Error: sizeShare is not defined (in finally van fill !)
// 8. position.getNivo() !!!
// 9. setFocusOnPosition >>> <a id="cnn" !!! >> id="££cnn"
// 10. fillX - refactor !!!
// 11. IMPORTANT: Refactor !!! Grid.method('setParentAndChild / nivo > 0 = child, other ???
// 12. sizeShare >> Check all over !!! in relation with splitter !!!
// 13. references_filter - *** keydown() ***
// 14. refreshPage() --- TOO MUCH ITERATIONS !!! ONLY ONE TIME !!! WITH CHECK ON NEW EVENTS (start at _cf.refresh() ???)
// 15. TOO MUCH RECURSION !!! setFocusOnList() !!!
// 16. TOO MUCH RECURSION Position.constructor !!! ALERT !!!
// 17. TOO MUCH RECURSION clickOnCell (2X) - (div + link) !!!
// 18. TOO MUCH RECURSION Entity.getEntityExpanded - set ALERT !!!
// 19. TOO MUCH RECURSION EntityCache.method('getEntityExpanded', function(id,name) - set ALERT !!!
// 20. switchRoot --- makeRoot (no parent/no child) !!!
// 21. Position - nivo - NOK (print gives not correct nivo !!!)
// 22. GridRange(nivo) - NOK (constructor,getNivo(),... ) REVIEW ALL!!!
// 23. Refactor setFocus / setFocusOnPosition / ... setFocus...
// 24. setMode - display/edit - esc/cancel/focus/... refactor.
// 25. ROOT - UNDO - REDO (with gridSnapShot:)
//     snapShot: {"root":rri,"rootEntity":rei,"where":[{"sei":sei,"r":r},...},"what":{{"sri":sri,"r":r},...]}		
// 26. ObjectList: first/next.previous/last - from server; scrolling (up,pup,down,pdn)
