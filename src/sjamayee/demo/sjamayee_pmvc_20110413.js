...
var Sjamayee = new Class({
  ...
  initialize: function(element, properties) {
    ...
    this.parent(Sjamayee.FORM,{height:window.innerHeight}); //-400}); 
  },
  initializeChildren: function() {
    //this.parent();
...
/*
    //this.splitter = new Splitter(document.body, {
    this.splitter = new Splitter($(Sjamayee.FORM), {
      'handleWidth':3,
      'handleColor':'red',
      ...
      'maximumSize':800,
      'opaqueResize':0});
		this.splitter.addWidget($("sjamayeeTop"), {
      'handleWidth':3,
      'handleColor':'red',
      'handleBorder':'3px solid red',
      'orientation':1,
      ...
      'maximumSize':400,
      'opaqueResize':0});
		this.splitter.addWidget($("sjamayeeBottom"), {
      'handleWidth':3,
      'handleColor':'blue',
      'handleBorder':'3px solid red',
      'orientation':1,
...
*/
    this.splitter = new Splitter($(Sjamayee.FORM), {
      ...
      'orientation':1,
      'minimumSize':0,
      'maximumSize':window.innerHeight, //-400, //1000,
      'opaqueResize':0});
		this.splitter.addWidget($("headerPane"), {
      'handleWidth':3,
      'handleColor':'lime',
      'handleBorder':'3px solid lime',
      'orientation':1,
      'minimumSize':26,
      'maximumSize':26,
      'opaqueResize':0});
		this.splitter.addWidget($("listPaneBorder"), {
      'handleWidth':3,
      'handleColor':'transparent', //'yellow',
      'handleBorder':'3px solid transparent', //yellow',
      'orientation':1,
      'minimumSize':800, /*50,*/
      'maximumSize':2000,
      'opaqueResize':0});
		this.splitter.addWidget($("toolBarPane"), {
      'handleWidth':3,
      'handleColor':'red',
      'handleBorder':'3px solid red',
      'orientation':1,
      ...
      'maximumSize':28,
      'opaqueResize':0});
		this.splitter.addWidget($("detailPane"), {
      'handleWidth':3,
      'handleColor':'green',
      'handleBorder':'3px solid green',
      'orientation':1,
      'minimumSize':220, /*100,*/
      'maximumSize':420, /*200,*/
      'opaqueResize':0});
		this.splitter.addWidget($("googleBranding"), {
      'handleWidth':1,
      'handleColor':'lightgray', //'black',
      'handleBorder':'1px solid lightgray', //black',
      'orientation':1,
      'minimumSize':20,
      'maximumSize':20,
      'opaqueResize':0});
...
var AttributeListUIComponent = new Class({
  ...
  initialize: function(name,properties) {
    ...
    this.splitter = new Splitter($(name+"X"));
...
var GridListSplitter = new Class({
  ...
  initializeChildren: function() {
    ...
    this.splitter = new Splitter($(GridListSplitter.ID), {'handleWidth':4,'handleColor':'lightgray'});//,'handleBorder':'10px solid red'});
		this.splitter.addWidget($(GridListLeft.ID), {'handleWidth':4,'handleColor':'lightgray'});//,'handleBorder':'10px solid red'});
		this.splitter.addWidget($(GridListRight.ID), {'handleWidth':4,'handleColor':'lightgray'});//,'handleBorder':'10px solid red'});
  }
});
...
var DetailSplitter = new Class({
  ...
  initializeChildren: function() {
    ...
    this.addChild(this.right);
    this.splitter = new Splitter($(DetailSplitter.ID), {'handleWidth':4,'handleColor':'lightgray','minimumSize':0});//,'handleBorder':'10px solid lime'});
		this.splitter.addWidget($(DetailLeft.ID), {'handleWidth':4,'handleColor':'lightgray','minimumSize':0});//,'handleBorder':'10px solid lime'});
		this.splitter.addWidget($(DetailRight.ID), {'handleWidth':4,'handleColor':'lightgray','minimumSize':0});//,'handleBorder':'10px solid lime'});    
  }
});
...
var DataParentDetail = new Class({
  ...
  initializeChildren: function() {
    ...
    //this.splitter = new Splitter($(DataParentDetail.ID));
    this.splitter = new Splitter($(DataParentDetail.ID), {
      'handleWidth':3,
      ...
      'minimumSize':100,
      'opaqueResize':0});
		this.splitter.addWidget($(DataParentNTD.ID), {
      'handleWidth':3,
      'handleColor':'inherit', //DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'lightblue',
      'handleBorder':'3px solid inherit'+DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
      'minimumSize':100,
      'opaqueResize':0});
		this.splitter.addWidget($(DataParentProperties.ID), {
      'handleWidth':3,
      'handleColor':'inherit', //DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'lightblue',
      'handleBorder':'3px solid inherit'+DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
...
var ModelParentDetail = new Class({
  ...
  initializeChildren: function() {
    ...
    this.addChild(this.properties);
    //this.splitter = new Splitter($(ModelParentDetail.ID));
    this.splitter = new Splitter($(ModelParentDetail.ID), {
      'handleWidth':3,
      ...
      'minimumSize':150,
      'opaqueResize':0});
		this.splitter.addWidget($(ModelParentNTD.ID), {
      'handleWidth':3,
      'handleColor':ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'red',
      'handleBorder':'3px solid '+ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
      'minimumSize':150,
      'opaqueResize':0});
		this.splitter.addWidget($(ModelParentProperties.ID), {
      'handleWidth':3,
      'handleColor':ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'red',
      'handleBorder':'3px solid '+ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
...
var DataChildDetail = new Class({
  ...
  initializeChildren: function() {
    ...
    this.addChild(this.properties);
    //this.splitter = new Splitter($(DataChildDetail.ID));
    this.splitter = new Splitter($(DataChildDetail.ID), {
      'handleWidth':3,
      ...
      'minimumSize':200,
      'opaqueResize':0});
		this.splitter.addWidget($(DataChildNTD.ID), {
      'handleWidth':3,
      'handleColor':DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'lightgreen',
      'handleBorder':'3px solid '+DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
      'minimumSize':200,
      'opaqueResize':0});
		this.splitter.addWidget($(DataChildProperties.ID), {
      'handleWidth':3,
      'handleColor':DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'lightgreen',
      'handleBorder':'3px solid '+DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
...
var ModelChildDetail = new Class({
  ...
  initializeChildren: function() {
    ...
    this.addChild(this.properties);
    //this.splitter = new Splitter($(ModelChildDetail.ID));
    this.splitter = new Splitter($(ModelChildDetail.ID), {
      'handleWidth':3,
      'handleColor':ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'red',
      'handleBorder':'3px solid '+ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      ...
      'minimumSize':250,
      'opaqueResize':0});
		this.splitter.addWidget($(ModelChildNTD.ID), {
      'handleWidth':3,
      'handleColor':ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'red',
      'handleBorder':'3px solid '+ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
      'minimumSize':250,
      'opaqueResize':0});
		this.splitter.addWidget($(ModelChildProperties.ID), {
      'handleWidth':3,
      'handleColor':ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'red',
      'handleBorder':'3px solid '+ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR,
      'orientation':0,
