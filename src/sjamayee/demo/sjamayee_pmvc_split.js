...
/*
<!-- HEADERPANE -->
<div id="headerPane" style="vertical-align:top;margin:0px 0px 10px 0px;width:100%;height:26px;display:block;"></div> <!-- 24px -->
<div id="listPaneBorder" class="normalBorder listPaneBorder" style="background-color:inherit;vertical-align:top;width:100%;height:220px;margin-top:3px;">
 <div id="listSplitter" jsId="jsGridSplitter" class="tundra gridSplitter" dojoType="dijit.layout.BorderContainer" design="sidebar" liveSplitters="true" persist="false" gutters="true" style="background-color:white;width:100%;height:100%;">
  <!-- LIST-/GRIDPANE -->
  <div id="listPaneLeft" class="listPane" dojoType="dijit.layout.ContentPane" region="left" splitter="true" style="height:100%;width:35%;background-color:inherit;overflow:hidden;" sizeShare="35" sizeMin="10"></div>
  <div id="listPaneRight" class="listPane" dojoType="dijit.layout.ContentPane" region="center" splitter="true" style="height:100%;background-color:inherit;overflow:hidden;" sizeMin="10" tabindex="-1"></div>
 </div>
</div>
<!-- TOOLBARPANE -->
<div id="toolBarPane" style="vertical-align:top;width:100%;height:28px;display:block;" tabindex="-1"></div>
<div id="detailPane" class="listPane" style="width:100%;height:217px;border:1px solid lightgray;background-color:inherit;display:block;" tabindex="-1">
 <div id="detailSplitter" jsId="jsDetailSplitter" class="tundra gridSplitter" dojoType="dijit.layout.BorderContainer" design="sidebar" liveSplitters="true" persist="false" gutters="true"
			style="background-color:inherit;vertical-align:top;width:100%;height:100%;" tabindex="-1" onmouseup="resizePanes('detailPaneLeft','detailPaneRight')">
  <!-- DETAILPANE -->
  <div id="detailPaneLeft" class="listPane" dojoType="dijit.layout.ContentPane" region="left" splitter="true" style="height:100%;width:35%;background-color:white;overflow:hidden;display:block;" sizeShare="35" sizeMin="10" tabindex="-1"></div>
  <div id="detailPaneRight" class="listPane" dojoType="dijit.layout.ContentPane" region="center" splitter="true" style="height:100%;background-color:white;overflow:hidden;display:block;" sizeMin="10" tabindex="-1"></div>
 </div>
</div>
*/
  initializeChildren: function() {
...
/*
    //this.splitter = new Splitter($(Sjamayee.FORM), {'handleWidth':10,'orientation':1,'opaqueResize':0});
    //var sjamayeeForm = $("sjamayeeFORM");
    this.splitter = new Splitter(document.body, {'handleWidth':10,'orientation':1,'opaqueResize':0});
		this.splitter.addWidget($(ToolBar.ID));
		this.splitter.addWidget($(Detail.ID));
*/
  },
  initializationComplete: function() {
...
//  var html = '<div id="'+Header.DATA_MODEL_HEADER_ID+'">'+
    ...
    var html = '<div id="headerPane" style="vertical-align:top;margin:0px 0px 10px 0px;width:100%;height:26px;display:block;">'+
               '<div id="'+Header.DATA_MODEL_HEADER_ID+'">'+
...
var AttributeListUIComponent = new Class({
  ...
  initialize: function(name,properties) {
    ...
    this.splitter = new Splitter($(name+"X"), {'handleWidth':1,'orientation':0,'opaqueResize':0});
		this.splitter.addWidget($(name+AttributeListUIComponent.NAMES_ID));
		this.splitter.addWidget($(name+AttributeListUIComponent.VALUES_ID));
  },
  initializeChildren: function() {
    var name = this.id;
...
//    <div id="listPaneBorder" class="normalBorder listPaneBorder" style="background-color:inherit;vertical-align:top;width:100%;height:220px;margin-top:3px;">
    ...
    var html = '<div id="headerPane" style="vertical-align:top;margin:0px 0px 10px 0px;width:100%;height:26px;display:block;"></div>';
...
//    <div id="listSplitter" jsId="jsGridSplitter" class="tundra gridSplitter" dojoType="dijit.layout.BorderContainer" design="sidebar" liveSplitters="true" persist="false" gutters="true" style="background-color:white;width:100%;height:100%;">
    ...
    var html = '<div id="listSplitter" jsId="jsGridSplitter" class="tundra gridSplitter" dojoType="dijit.layout.BorderContainer" design="sidebar" liveSplitters="true" persist="false" gutters="true" style="background-color:white;width:100%;height:100%;"></div>';
    this.parent(GridListSplitter.ID,{html: html});
    this.left = null;
    this.right = null;
  },
  initializeChildren: function() {
...
//  <div id="listPaneLeft" class="listPane" dojoType="dijit.layout.ContentPane" region="left" splitter="true" style="height:100%;width:35%;background-color:inherit;overflow:hidden;" sizeShare="35" sizeMin="10"></div>
    ...
    var html = '<div id="listPaneLeft" class="listPane" dojoType="dijit.layout.ContentPane" region="left" splitter="true" style="height:100%;width:35%;background-color:inherit;overflow:hidden;" sizeShare="35" sizeMin="10">'+
               /*'<div id="'+DataObjectsListLeft.ID+'" class="'+GridListLeft.CLASS_ID+'"></div>'+
...
//  <div id="listPaneRight" class="listPane" dojoType="dijit.layout.ContentPane" region="center" splitter="true" style="height:100%;background-color:inherit;overflow:hidden;" sizeMin="10" tabindex="-1"></div>
    ...
    var html = '<div id="listPaneRight" class="listPane" dojoType="dijit.layout.ContentPane" region="center" splitter="true" style="height:100%;background-color:inherit;overflow:hidden;" sizeMin="10" tabindex="-1">'+
               /*'<div id="'+DataObjectsListRight.ID+'" class="'+GridListRight.CLASS_ID+'"></div>'+
...
//  var html = '<div id="'+DataObjectsToolBar.ID+'" class="'+ToolBar.CLASS_ID+'"></div>'+
    ...
    var html = '<div id="toolBarPane" style="vertical-align:top;width:100%;height:28px;display:block;" tabindex="-1">'+
...
var Detail = new Class({
  ...
  initialize: function() {
    ...
    var html = '<div id="detailPane" class="listPane" style="width:100%;height:217px;border:1px solid lightgray;background-color:inherit;display:block;" tabindex="-1"></div>';
...
// 			style="background-color:inherit;vertical-align:top;width:100%;height:100%;" tabindex="-1" onmouseup="resizePanes('detailPaneLeft','detailPaneRight')">
    ...
    var html = '<div id="detailSplitter" jsId="jsDetailSplitter" class="tundra gridSplitter" dojoType="dijit.layout.BorderContainer" design="sidebar" liveSplitters="true" persist="false" gutters="true" '+
   			       'style="background-color:inherit;vertical-align:top;width:100%;height:100%;" tabindex="-1" onmouseup="resizePanes(\'detailPaneLeft\',\'detailPaneRight\')"></div>';
    this.parent(DetailSplitter.ID, {html: html});
    this.left = null;
    this.right = null;
  },
  initializeChildren: function() {
...
//  var html = '<div id="'+DataObjectNTD.ID+'" class="'+ObjectNTD.CLASS_ID+'"></div>'+
    ...
    var html = '<div id="detailPaneLeft" class="listPane" dojoType="dijit.layout.ContentPane" region="left" splitter="true" style="height:100%;width:35%;background-color:white;overflow:hidden;display:block;" sizeShare="35" sizeMin="10" tabindex="-1">'+
               /*'<div id="'+DataObjectNTD.ID+'" class="'+ObjectNTD.CLASS_ID+'"></div>'+
...
//  var html = '<div id="'+DataObjectProperties.ID+'" class="'+ObjectProperties.CLASS_ID+'"></div>'+
    ...
    var html = '<div id="detailPaneRight" class="listPane" dojoType="dijit.layout.ContentPane" region="center" splitter="true" style="height:100%;background-color:white;overflow:hidden;display:block;" sizeMin="10" tabindex="-1">'+
               /*'<div id="'+DataObjectProperties.ID+'" class="'+ObjectProperties.CLASS_ID+'"></div>'+
...
var DataObjectProperties = new Class({
  ...
  initialize: function() {
    ...
    /*this.splitter = new Splitter(false, {'handleWidth':1,'orientation':1,'opaqueResize':0});*/
  }
/*,
