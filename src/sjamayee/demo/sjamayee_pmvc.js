/* Examples SHA1 ***
XXXX 1234567890123456789012345678901234567890
---------------------------------------------
0    b6589fc6ab0dc82cf12099d1c2d40ab994e8410c
00   fb96549631c835eb239cd614cc6b5cb7d295121a
000  8aefb06c426e07a0a671a1e2488b4858d694a730
0000 39dfa55283318d31afe5a3ff4a0e3253e2045e43
1    356a192b7913b04c54574d18c28d46e6395428ab
01   ddfe163345d338193ac2bdc183f8e9dcff904b43
001  e193a01ecf8d30ad0affefd332ce934e32ffce72
0001 7a6779700f09e1eafe9ad40e390f3a15b94dfa4b
CDAT c1dfd96eea8cc2b62785275bca38ac261256e278
AMNT 2e733781f0d7a4db5b3d40eaa52421260d4480c3
PROJ 356a192b7913b04c54574d18c28d46e6395428ab
URL  02ab1d192d9d5f2010a2bc06da3c84f2e9bb08c1
RSRC da4b9237bacccdf19c0760cab7aec4a8359010b0
PRRS 77de68daecd823babbb58edb1c8e14d7106e83bb
RTYP ac3478d69a3c81fa62e60f5c3696165a4e5e6ac4
RUSG 1b6453892473a467d07372d45eb05abc2031647a
*/

/*
loadModelEntities({"entities":[
{"id":"125","name":"Resource Usage","ver":"0","code":null,"description":"Resource usage definition.","tid":"4","txi":null},
{"id":"127","name":"ResourceUsageDate","ver":"0","code":"RUDT","description":"Resource usage date.","tid":"6","txi":null},
{"id":"23","name":"Resource Type","ver":"0","code":null,"description":"Resource type definition.","tid":"5","txi":null},
{"id":"29","name":"Project","ver":"0","code":null,"description":"Project definition.","tid":"1","txi":null},
{"id":"30","name":"ProjectStartDate","ver":"0","code":"PSDT","description":"Project start date.","tid":"6","txi":null},
{"id":"32","name":"ProjectEndDate","ver":"0","code":"PEDT","description":"Project end date.","tid":"6","txi":null},
{"id":"58","name":"Resource","ver":"0","code":null,"description":"Resource definition.","tid":"2","txi":null},
{"id":"7","name":"Calendar Date","ver":"0","code":null,"description":"Calendar date definition.","tid":"6","txi":null},
{"id":"74","name":"Project Resource","ver":"0","code":null,"description":"Project Resource linkage.","tid":"3","txi":null},
{"id":"7000000001","name":"Financial Project","ver":"0","code":"FPRO","description":"Financial Project definition.","tid":"1","txi":null},
{"id":"7000000002","name":"IT Project","ver":"0","code":"ITPR","description":"Informatic Technology Project definition.","tid":"1","txi":null},
{"id":"7000000003","name":"CE Project","ver":"0","code":"CEPR","description":"Civil Engineering Project definition.","tid":"1","txi":null}
]});

loadModelEntities({"entities":[
{"id":"125","name":"Resource Usage","ver":"0","code":"RUSG","description":"Resource usage definition.","tid":"4","txi":null},
{"id":"127","name":"ResourceUsageDate","ver":"0","code":"RUDT","description":"Resource usage date.","tid":"6","txi":null},
{"id":"23","name":"Resource Type","ver":"0","code":"RTYP","description":"Resource type definition.","tid":"5","txi":null},
{"id":"29","name":"Project","ver":"0","code":"PROJ","description":"Project definition.","tid":"1","txi":null},
{"id":"30","name":"ProjectStartDate","ver":"0","code":"PSDT","description":"Project start date.","tid":"6","txi":null},
{"id":"32","name":"ProjectEndDate","ver":"0","code":"PEDT","description":"Project end date.","tid":"6","txi":null},
{"id":"58","name":"Resource","ver":"0","code":"RSRC","description":"Resource definition.","tid":"2","txi":null},
{"id":"7","name":"Calendar Date","ver":"0","code":null,"description":"Calendar date definition.","tid":"6","txi":null},
{"id":"74","name":"Project Resource","ver":"0","code":"PRRS","description":"Project Resource linkage.","tid":"3","txi":null},
{"id":"7000000001","name":"Financial Project","ver":"0","code":"FPRO","description":"Financial Project definition.","tid":"1","txi":null},
{"id":"7000000002","name":"IT Project","ver":"0","code":"ITPR","description":"Informatic Technology Project definition.","tid":"1","txi":null},
{"id":"7000000003","name":"CE Project","ver":"0","code":"CEPR","description":"Civil Engineering Project definition.","tid":"1","txi":null}
]});
...
/*
var lastGroupCommand = this.getLastGroupCommand();           //TODO: !!!!!
this.setChildCell(childCell);   	                            //VERIFY THIS !!! >>TODO !!!
this.setLastCommand(command,true);                          //idem
var commandBuffer = this.getCommandBuffer(); //TODO: this !!!  (>mediator)
mediator.grid.setRootCommand(null);
/////////////////////////////////////////////////////////////////////////////////////////////////////////
*/

/*
RelationsForm.                        >> TODO in grid.js
SjamayeeForm.                         >> TODO
*/

/* TODO !!!!!!!!!!!!!!!
- getParentRelations - limit on page/size !!!!
- check page/size 9/10 - see ObjectsList - OTHERS !!!
*/
/* SOQL
select d.sja__modelEntity__r.sja__type__r.id,
       d.sja__modelEntity__r.sja__type__r.sja__type__c type__c,
       d.sja__modelEntity__r.sja__type__r.name,
       d.sja__modelEntity__r.sja__type__r.sja__description__c description__c,
       d.sja__modelEntity__r.sja__type__r.sja__objectType__c objectType__c,
       d.sja__modelEntity__r.sja__type__r.sja__inUse__c inUse__c
  from sja__DataEntity__c d 
group by d.sja__modelEntity__r.sja__type__r.id,
         d.sja__modelEntity__r.sja__type__r.sja__type__c,
         d.sja__modelEntity__r.sja__type__r.name,
         d.sja__modelEntity__r.sja__type__r.sja__description__c,
         d.sja__modelEntity__r.sja__type__r.sja__objectType__c,
         d.sja__modelEntity__r.sja__type__r.sja__inUse__c
order by d.sja__modelEntity__r.sja__type__r.sja__type__c ASC

select id,type__c,name,description__c,objectType__c,inUse__c from Type__c
select id,sja__type__c,name,sja__description__c,sja__objectType__c,sja__inUse__c from sja__Type__c

private static String SQL_TEXT = 'select id,type__c,name,description__c,'+
                                 '       objectType__c,inUse__c '+
                                 '  from Type__c';

private static String SQL_TEXT_DT = 'select d.modelEntity__r.type__r.id,'+
                                           'd.modelEntity__r.type__r.type__c,'+
                                           'd.modelEntity__r.type__r.name,'+
                                           'd.modelEntity__r.type__r.description__c,'+
                                           'd.modelEntity__r.type__r.objectType__c,'+
                                           'd.modelEntity__r.type__r.inUse__c '+
                                    '  from dataEntity__c d '+ 
                                    'group by d.modelEntity__r.type__r.id,'+
                                             'd.modelEntity__r.type__r.type__c,'+
                                             'd.modelEntity__r.type__r.name,'+
                                             'd.modelEntity__r.type__r.description__c,'+
                                             'd.modelEntity__r.type__r.objectType__c,'+
...
//DISTINCT ModelEntities
select d.sja__modelEntity__c from sja__dataEntity__c d group by d.sja__modelEntity__c
*/
/*
sforce.apex.execute('sja.TypeService','getTypes',{});
//sforce.apex.execute('sja.TypeService','getSfdcFieldNames',{type:this.getName()});
sforce.apex.execute('sja.DataEntityService','getEntities',{});
sforce.apex.execute('sja.DataRelationService','getRelations',{});
sforce.apex.execute('sja.ModelEntityService','getEntities',{});
//sforce.apex.execute('sja.ModelEntityService','getSfdcObject',{oid:this.getOid(),entityType:this.getType()});
*/

//------------ *** SF *** -------------//
// Sjamayee PureMVC Javascript Library //
//-------------------------------------//
/*
//Facade
SjamayeeFacade(Facade)
//Controller
DeleteUserCommand(SimpleCommand)
	...
	execute: function(note) {
      ...
      for (var j = 0; j < groupCommands.length; j++) {
				if (groupCommands[j]) {
			  	...
			  	var r1 = groupCommands[j].getRelation(); //TOD/ VERIFY - IS THIS OK ???
					if (r1) {
						this.mediator.previousRelation = null;
						this.mediator.nextRelation = null;
...
var ShowSFDCDataObjectCommand = new Class({
  Extends: ShowSFDCObjectCommand,
	execute: function(note) {
      ...
      this.parent(note);
      mediator.setMessageText("SFDC Object viewed!");
      mediator.setMessageText("SFDC Object viewed! (or SAP/Oracle/Documentum/...)");
		} catch(error) {
...
var ShowSFDCDataRelationCommand = new Class({
  Extends: ShowSFDCDataObjectCommand,
	execute: function(note) {
      ...
      mediator.setMessageText("SFDC Relation viewed! (or SAP/Oracle/Documentum/...)");      
		} catch(error) {
...
var ModelObjectsToolBarMediator = new Class({
  ...
  onClearBuffer: function()         {	this.sendNotification(SjamayeeFacade.OLIST_MODEL_BUFFER_CLEAR); },
  onEditText: function()	          {	this.sendNotification(SjamayeeFacade.OLIST_MODEL_TEXT_EDIT); },
  onDeleteUnrefObjects: function()	{	this.sendNotification(SjamayeeFacade.OLIST_MODEL_OBJECT_UNREFS_DELETE); },
...
var ModelRelationsToolBarMediator = new Class({
  ...
  onClearBuffer: function()	    { this.sendNotification(SjamayeeFacade.GRID_MODEL_BUFFER_CLEAR); },
  onEditText: function()	      { this.sendNotification(SjamayeeFacade.GRID_MODEL_TEXT_EDIT); },
  onResetGrid: function()	      { this.sendNotification(SjamayeeFacade.GRID_MODEL_RESET); },
...
var DataObjectsToolBarMediator = new Class({
  ...
  onClearBuffer: function()         {	this.sendNotification(SjamayeeFacade.OLIST_DATA_BUFFER_CLEAR); },
	//onEditText: function()	          {	this.sendNotification(SjamayeeFacade.OLIST_DATA_TEXT_EDIT); },
  onDeleteUnrefObjects: function()	{	this.sendNotification(SjamayeeFacade.OLIST_DATA_OBJECT_UNREFS_DELETE); },
...
var DataRelationsToolBarMediator = new Class({
  ...
  onClearBuffer: function()	    { this.sendNotification(SjamayeeFacade.GRID_DATA_BUFFER_CLEAR); },
	//onEditText: function()	      { this.sendNotification(SjamayeeFacade.GRID_DATA_TEXT_EDIT); },
  onResetGrid: function()	      { this.sendNotification(SjamayeeFacade.GRID_DATA_RESET); },
  ...
  onCellMouseOver: function(evt) {
	...
	listNotificationInterests: function()	{
	  ...
	  return result.concat([
  		...
  		SjamayeeFacade.GRID_DATA_BUFFER_CLEAR,
  		SjamayeeFacade.GRID_DATA_RESET
		]);
	},
  handleNotification: function(note)	{
    this.parent(note);
...
*/
      ...
      var relationsEntityName = relationsHeaderMediator.getViewComponent().getEntitySelectValue();
    	...
    	this.sendNotification(SjamayeeFacade.RELATION_REDO);
  		break;
  		case SjamayeeFacade.GRID_DATA_BUFFER_CLEAR:
    	this.sendNotification(SjamayeeFacade.GRID_BUFFER_CLEAR);
  		break;
  		case SjamayeeFacade.GRID_DATA_RESET:
    	this.sendNotification(SjamayeeFacade.GRID_RESET);
  		break;						
