var DataRelationsGridMediator = function() {
	...
	this.initialize = function(viewComponent)	{
	  ...
	  var gridLeft = gridList.gridListSplitter.left.dataRelationsGrid;
	  var gridRight = gridList.gridListSplitter.right.dataRelationsGrid;
    /*gridLeft.addEvent(SjamayeeFacade.GRID_DATA_LEFT_CELL_MOUSEOVER, this.onCellMouseOver);
    gridLeft.addEvent(SjamayeeFacade.GRID_DATA_LEFT_CELL_MOUSEOUT, this.onCellMouseOut);
    gridRight.addEvent(SjamayeeFacade.GRID_DATA_RIGHT_CELL_MOUSEOVER, this.onCellMouseOver);
    gridRight.addEvent(SjamayeeFacade.GRID_DATA_RIGHT_CELL_MOUSEOUT, this.onCellMouseOut);
    gridLeft.addEvent(SjamayeeFacade.GRID_DATA_LEFT_CELL_CLICK, this.onCellClick);
    gridRight.addEvent(SjamayeeFacade.GRID_DATA_RIGHT_CELL_CLICK, this.onCellClick);*/
    ...
    gridList.addEvent(SjamayeeFacade.GRID_DATA_CELL_CLICK, this.onCellClick);
    ...
    //gridList.addEvent(SjamayeeFacade.GRID_DATA_LEFT, this.onLeft);
    //gridList.addEvent(SjamayeeFacade.GRID_DATA_RIGHT, this.onRight);
  ...
  this.onKeyDown = function(subEvent) {
		alert("DataRelationsGridMediator/onKeyDown - subEvent: "+subEvent);
  };
	...
	this.listNotificationInterests = function()	{
	  ...
	  return result.concat([
  		...
  		SjamayeeFacade.DATA_ROOT_REDO,
			...
			SjamayeeFacade.GRID_DATA_HOME,
  		SjamayeeFacade.GRID_DATA_PREVIOUS,
  		SjamayeeFacade.GRID_DATA_UP,
  		SjamayeeFacade.GRID_DATA_LEFT,
  		SjamayeeFacade.GRID_DATA_RIGHT,
  		SjamayeeFacade.GRID_DATA_DOWN,
  		SjamayeeFacade.GRID_DATA_NEXT,
  		SjamayeeFacade.GRID_DATA_END,
    ...
    this.parent(note);
		...
		switch (note.getName())	{
			...
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_SHOW");
		...
		//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_REFRESH");
			this.fillGrid();
      ...
      */			
		  ...
		  case SjamayeeFacade.GRID_DATA_ENTITY_CHANGE:
			var entityName = note.getBody();
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_ENTITY_CHANGE - entityName: "+entityName);
	    ...
	    case SjamayeeFacade.GRID_DATA_TYPE_CHANGE:
			...
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_TYPE_CHANGE - typeName: "+typeName);
			//this.sendNotification(SjamayeeFacade.FOCUS, RelationsGridRight.ID);
			break;
  		case SjamayeeFacade.GRID_DATA_FILTER_CLICK:
  		//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_FILTER_CLICK");
  		break;
			case SjamayeeFacade.GRID_DATA_HOME:
		//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_HOME");
			var position = this.getPosition();
			position.setRow(this.getBeginOfList());
			this.home();
			break;
			case SjamayeeFacade.GRID_DATA_PREVIOUS:
		//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_PREVIOUS");
			break;
			case SjamayeeFacade.GRID_DATA_UP:
		//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_UP");
			//var position = this.getPosition();
		  ...
		  alert("DataRelationsGridMediator/handleNotification - GRID_DATA_LEFT - name: "+this.getUicName()+" nivo: "+this.getCurrentNivo());
			var ok = false;
			var homeView = false;
 			var relation = null;
			var nextColumn = null;
...
*/
			...
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_LEFT - nivo: "+nivo+" column: "+col+" row: "+row);
			//Fill grid.
			this.fillGrid();
			break;
			case SjamayeeFacade.GRID_DATA_RIGHT:
		  alert("DataRelationsGridMediator/handleNotification - GRID_DATA_RIGHT");
			var ok = false;
			var homeView = false;
			var relation = null;
			var nextColumn = null;
...
*/
			//var col = this.getPosition().getColumn();
			//var row = this.getPosition().getRow();
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_RIGHT - nivo: "+nivo+" column: "+col+" row: "+row);			
			//Fill grid.
			this.fillGrid();
			break;
			case SjamayeeFacade.GRID_DATA_DOWN:
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_DOWN");
			//var position = this.getPosition();
			//position.setRow(position.getRow()+1);
			this.lineDown();
			//Fill grid.
			...
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_NEXT");
			break;
			case SjamayeeFacade.GRID_DATA_END:
			//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_END");
			var position = this.getPosition();
			position.setRow(this.getEndOfList());
			this.end();
			break;
			case SjamayeeFacade.GRID_DATA_RESIZE:
		  //alert("DataRelationsGridMediator/handleNotification - GRID_DATA_RESIZE");
    	...
    	this.sendNotification(SjamayeeFacade.GRID_DATA_REFRESH);
		  ...
		  //alert("DataRelationsGridMediator/handleNotification - DATA_TYPES_RELOAD");
      ...
      var relationsEntityName = relationsHeaderMediator.getViewComponent().entitySelect.value;
	    this.sendNotification(SjamayeeFacade.GRID_DARA_ENTITY_CHANGE,relationsEntityName);
			break;
  		case SjamayeeFacade.GRID_DATA_RELATION_ADD:
  		//alert("DataRelationsGridMediator/handleNotification - GRID_DATA_RELATION_ADD");
  		this.setEdit();
  ...
  this.setResizeButtonText = function(text) {
	...
	this.setGridSize = function(gridSize) {
	  //alert("DataRelationsGridMediator/setGridSize - gridSize: "+gridSize);
  ...
  this.createRelationVO = function(entity) {
    return new DataRelationVO(null,null,"",null,entity.getId(),null,null);
  };

  this.createRelation = function(vo) {
	//alert("DataRelationsGridMediator/createRelation - dr: "+(new DataRelation(vo)).print());    
    return new DataRelation(vo);
  };
};
DataRelationsGridMediator = new Class(new DataRelationsGridMediator());
