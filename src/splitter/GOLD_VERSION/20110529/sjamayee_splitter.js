...
var Splitter = new Class({
  ...
  addWidget: function(widget,parameters) {
    ...
    if (initialSize.charAt(initialSize.length-1) == '%') {
  	...
  	var sizes = [];
  	var w = 0;
  	if (numWidgets) w += numWidgets * this.handleWidth; //this.handleWidth;
...
var AttributeListUIComponent = new Class({
  ...
  initializationComplete: function() {
    ...
    this.hsplitter = new Splitter($(this.id+AttributeListUIComponent.BODY_ID), {'handleWidth':1,'handleColor':'lightgray','initialSize':'100%'}); //'lightgray'}); //'red'});
		this.hsplitter.addWidget($(this.id+AttributeListUIComponent.NAMES_ID), {'initialSize':'50%'}); //,{'handleColor':'lightgray'}); //, {'handleWidth':1});
		this.hsplitter.addWidget($(this.id+AttributeListUIComponent.VALUES_ID), {'initialSize':'50%'}); //,{'handleColor':'lightgray'}); //, {'handleWidth':1});
  },
...
var DataParentDetail = new Class({
  ...
  initializationComplete: function() {
    this.hsplitter = new Splitter($(this.id), {
      'handleWidth':3,
      'handleColor':'white', //'inherit', //DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'lightblue',
...
var ModelParentDetail = new Class({
  ...
  initializationComplete: function() {
    this.hsplitter = new Splitter($(this.id), {
      'handleWidth':3,
      'handleColor':'white', //ModelRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'red',
...
var DataChildDetail = new Class({
  ...
  initializationComplete: function() {
    this.hsplitter = new Splitter($(this.id), {
      'handleWidth':3,
      'handleColor':'white', //DataRelationsGridMediator.BACKGROUND_HIGHLITE_COLOR, //'lightgreen',
