  ...
  addWidget: function(widget,parameters) {
    ...
    handle.addEvent('mousedown', function() {
  		...
  		var mouseup = function(e) {
			  ...
			  var parent = handle.parentNode; //this.
    ...
    if (initialSize.charAt(initialSize.length-1) == '%') {
  	  var i = Number(initialSize.substr(0,initialSize.length-1));
  	  var percent = (i / 100);
  		orientation?(wwHeight = parent.offsetHeight * percent, wwWidth = parent.offsetWidth)
  						   :(wwHeight = parent.offsetHeight, wwWidth = parent.offsetWidth * percent);
  	} else {
  	  var i = Number(initialSize.substr(0,initialSize.length-2));
  		orientation?(wwHeight = i, wwWidth = parent.offsetWidth)
    ...
    if (sizes.length > 0) {
  	...
  	for (var i = 0; i < sizes.length ; ++i) {
  		if (i) {
			  ...
			  x += this.handles[i].handleWidth; //this.handleWidth;
      }
...
var Sjamayee = new Class({
  ...
  initializationComplete: function() {
    this.vsplitter = new Splitter($(Sjamayee.FORM), {
      //'id':'splitTopBottom',
      'handleWidth':5,
      'handleColor':'inherit', //'yellow', //'inherit',
      'handleBorder':'none',
      'orientation':1,
      'minimumSize':'100%',
      'maximumSize':'100%',
...
var AttributeListUIComponent = new Class({
  ...
  initializationComplete: function() {
    //Add splitter.
    this.hsplitter = new Splitter($(this.id+AttributeListUIComponent.BODY_ID), {'handleWidth':1,'handleColor':'lightgray','initialSize':'100%'}); //'lightgray'}); //'red'});
...
var ToolBar = new Class({
  ...
  /*var html = '<div id="'+DataObjectsToolBar.ID+'" class="'+ToolBar.CLASS_ID+'"></div>'+
    ...
    var html = '<div id="'+DataObjectsToolBar.ID+'"></div>'+
               '<div id="'+DataRelationsToolBar.ID+'"></div>';
    if (SjamayeeFacade.APPLICATION_TYPE == SjamayeeFacade.COMPOSER) {               
      html += '<div id="'+ModelObjectsToolBar.ID+'"></div>'+
              '<div id="'+ModelRelationsToolBar.ID+'"></div>'+
              '<div id="'+ModelObjectsTextsToolBar.ID+'"></div>'+
              '<div id="'+ModelRelationsTextsToolBar.ID+'"></div>';
    }
...
ToolBar.CLASS_ID = "abcdef"; //"toolBar";
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      ...
      //parameters = (this.gridUIC.getColumnId(0).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
  		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(0)), parameters);
      //parameters = (this.gridUIC.getColumnId(1).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
  		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(1)), parameters);
      //parameters = (this.gridUIC.getColumnId(2).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
  		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(2)), parameters);
      //parameters = (this.gridUIC.getColumnId(3).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
  		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(3)), parameters);
      //Set show/hide
      ...
      for (var i = Position.COLUMN_FIRST(); i < Position.COLUMN_WHAT_FIRST(); i++) {
        ...
        this.gridUIC.hsplitter.addWidget($(columnId), parameters);
      }
      //Set show/hide
      /*$(this.gridUICLeft.getColumnId(0)).setAttribute("style","display:block;");
      $(this.gridUICLeft.getColumnId(1)).setAttribute("style","display:block;");
      ...
      if (Position.COLUMNS_MAX() > 2) {
        $(this.gridUIC.getColumnId(2)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(2).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUICLeft.getColumnId(2)), parameters);
      }
      if (Position.COLUMNS_MAX() > 3) {
        $(this.gridUIC.getColumnId(3)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(3).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUICLeft.getColumnId(3)), parameters);
      }
      if (Position.COLUMNS_MAX() > 4) {
        $(this.gridUIC.getColumnId(4)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(4).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUICLeft.getColumnId(4)), parameters);
      }
      if (Position.COLUMNS_MAX() > 5) {
        $(this.gridUIC.getColumnId(5)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(0).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUICLeft.getColumnId(5)), parameters);
      }
      if (Position.COLUMNS_MAX() > 6) {
        $(this.gridUIC.getColumnId(6)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(0).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUICLeft.getColumnId(6)), parameters);
      }
      for (var i = (Position.COLUMN_WHAT_FIRST() + 3); i < Position.COLUMNS_MAX(); i++) {
        $(this.gridUIC.getColumnId(i)).setAttribute("style","display:none;");
        //parameters = (this.gridUIC.getColumnId(i).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUICLeft.getColumnId(i)), parameters);
      }      
      gridList.setAttribute("style","width:100%;height:100%;display:block;");
      //this.resizeSplitter();
      break;
      ...
      if (Position.COLUMNS_MAX() > 4) {
        $(this.gridUIC.getColumnId(4)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(4).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(4)), parameters);
      }
      if (Position.COLUMNS_MAX() > 5) {
        $(this.gridUIC.getColumnId(5)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(5).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(5)), parameters);
      }
      if (Position.COLUMNS_MAX() > 6) {
        $(this.gridUIC.getColumnId(6)).setAttribute("style","display:block;");
        //parameters = (this.gridUIC.getColumnId(6).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(6)), parameters);
      }
      if (Position.COLUMNS_MAX() > 7) {
        ...
        //parameters = (this.gridUIC.getColumnId(7).getNivo() == Position.NIVO_ROOT())?{'handleWidth':5}:{};
    		this.gridUIC.hsplitter.addWidget($(this.gridUIC.getColumnId(7)), parameters);
      }
      gridList.setAttribute("style","width:100%;height:100%;display:block;");
...
var ModelObjectsHeaderMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      case SjamayeeFacade.OLIST_MODEL_HEADER_SHOW:
      this.hide();
      header.modelObjectsHeader.setAttribute("style","display:block;");
...
var ModelRelationsHeaderMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      case SjamayeeFacade.GRID_MODEL_HEADER_SHOW:
      this.hide();
      header.modelRelationsHeader.setAttribute("style","display:block;");
      header.setAttribute("style","display:block;");
      break;
...
var ModelObjectsToolBarMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      ...
      this.hide();
      this.enableButtons();
      //toolBar.modelObjectsToolBar.setAttribute("style","display:block;");
...
var ModelRelationsToolBarMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      ...
      this.hide();
      this.enableButtons();
      //toolBar.modelRelationsToolBar.setAttribute("style","display:block;");
      toolBar.setAttribute("style","display:block;");
      break;
...
var DataObjectsHeaderMediator = new Class({
  ...
  handleNotification: function(note) {
    ...
    switch (note.getName()) {
      ...
      this.hide();
      header.dataObjectsHeader.setAttribute("style","display:block;");
      header.setAttribute("style","display:block;");
      break;
...
var DataRelationsHeaderMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      ...
      this.hide();
      header.dataRelationsHeader.setAttribute("style","display:block;");
      header.setAttribute("style","display:block;");
      break;
...
var DataObjectsToolBarMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      ...
      this.hide();
      this.enableButtons();
      //toolBar.dataObjectsToolBar.setAttribute("style","display:block;");
      toolBar.setAttribute("style","display:block;");
      break;
    }
  }
...
var DataRelationsToolBarMediator = new Class({
  ...
  handleNotification: function(note)  {
    ...
    switch (note.getName()) {
      ...
      this.hide();
      this.enableButtons();
      //toolBar.dataRelationsToolBar.setAttribute("style","display:block;");
      toolBar.setAttribute("style","display:block;");
      break;
